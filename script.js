...
const API_KEY = '4cccadccf4be061ccf56ed2d4f1cf1c2'
...
function showWeatherData(data) {
    ...
    textContentDescription.textContent = `Meteorology Description:`
    ...
    divResponseData.appendChild(textContentDescription)
